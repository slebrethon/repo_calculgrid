...
function showStep() {
  ...
  // Titre
  const title = document.getElementById('tutoTitle');

  if (title) {
    title.innerHTML = getText(step.titleKey);
  }

  // Texte
  const text = document.getElementById('tutoText');

  if (text) {
    text.innerHTML = getText(step.textKey);
  }
  ...
  const counter = document.getElementById('tutoCounter');

  if (counter) {
    counter.textContent = current + ' / ' + total;
  }

  const fill = document.getElementById('tutoProgressFill');
  ...
  const btnQuit = document.getElementById('modalQuit');

  if (btnPrev) {
    btnPrev.textContent = getText('tuto_btn_prev');
  ...
  if (btnNext) {
    if (currentStep === total - 1) {
      btnNext.textContent =
        getText('tuto_btn_finish') || getText('tuto_btn_next');
    } else {
      btnNext.textContent = getText('tuto_btn_next');
    }
  ...
  if (btnQuit) {
    btnQuit.textContent = getText('tuto_btn_quit');
  }
}
